...
- Added hundredth-percent stat allocation, contextual one-stat arrow-key stepping, automatic population of zero-valued stat rows, and bottom-row budget balancing.
